...
export class LegendManager {
  ...
  updateCorrelationLegend() {
    ...
    const legendHeader = legend.append('div').style('margin-bottom', '15px');
    ...
    const gradientDiv = legendHeader
      .append('div')
      .style('display', 'flex')
  ...
  updateLegend(currentView) {
    ...
    if (currentView === 'depth' || currentView === 'horizontal') {
      ...
      legend
        ...
        .style(
          'box-shadow',
          '0 15px 35px rgba(0, 0, 0, 0.1), 0 0 0 1px rgba(255, 255, 255, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.8)'
        ).html(`
  ...
  updateSecchiLegend() {
    ...
    seasons.forEach((season) => {
      ...
      seasonDiv.append('span').text(season.name);
    });
